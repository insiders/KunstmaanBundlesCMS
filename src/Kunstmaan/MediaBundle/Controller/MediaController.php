...
final class MediaController extends AbstractController
{
     ...
     */
    #[Route(path: 'create/modal/{folderId}/{fileType}', requirements: ['folderId' => '\d+', 'fileType' => '.+'], name: 'KunstmaanMediaBundle_media_modal_create', methods: ['POST'])]
    public function createModalAction(Request $request, $folderId, $fileType): array|RedirectResponse
    {
